...
```sh
wget -O /tmp/enigma2-plugin-extensions-online-picons.deb https://raw.githubusercontent.com/dreamboxone/online-picons/main/releases/enigma2-plugin-extensions-online-picons_1.0.2_all.deb && dpkg -i /tmp/enigma2-plugin-extensions-online-picons.deb
```
...
`enigma2-plugin-extensions-online-picons_1.0.2_all.deb`

سپس اجرا کنید:

```sh
dpkg -i /tmp/enigma2-plugin-extensions-online-picons_1.0.2_all.deb
```
